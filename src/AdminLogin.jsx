...
function SuperUserLogin() {
  ...
  const handleLogin = (e) => {
    ...
    const defaultUsername = (process.env.REACT_APP_ADMIN_USER || "").replace(/"/g, '').trim();
    const defaultPassword = (process.env.REACT_APP_ADMIN_PASS || "").replace(/"/g, '').trim();
    ...
    <div className="login-container">
      <div className="login-wrapper">
        ...
        <div className="login-welcome" style={{ backgroundImage: "url('/employee.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
          ...
          <p>
            System Administrator Access. Authorized personnel only. Please verify your credentials to manage the onboarding portal.
          </p>
          <button className="learn-more-btn">Security Guide</button>
        </div>
