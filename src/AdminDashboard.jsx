        ...
        <div className={`ad-portal-container ${isSidebarOpen ? 'ad-sidebar-active' : ''}`}>
            ...
            <div className={`ad-side-panel ${isSidebarOpen ? 'active' : ''}`}>
                ...
                <div className="ad-nav-group">
                    ...
                    <div className={`ad-nav-link ${activeTab === 'requests' ? 'active' : ''}`} onClick={() => { setActiveTab('requests'); setIsSidebarOpen(false); }}>
            ...
            <div className="ad-main-view">
                ...
                {activeTab === 'dashboard' ? (
                        ...
                        <div className="ad-widget-row">
                            <div className="ad-widget-panel">
                                ...
                                <GenderDonutChart 
                                    ...
                                    other={employees.filter(e => e.Gender && !['male', 'female'].includes(e.Gender.toLowerCase())).length} 
                                />
                            </div>
                            <div className="ad-widget-panel">
                                <div className="ad-widget-title">
                    ...
                    /* General Approvals Tab Content */
                    <div className="ad-attendance-panel animate-fade-in">
                        <div style={{ marginBottom: '25px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h2 style={{ fontSize: '20px', fontWeight: '800', color: '#0f172a', margin: 0 }}>Pending Approvals</h2>
                            <button className="ad-primary-action-btn" onClick={loadRequests}>Refresh Requests</button>
                        </div>
                                ...
                                <table className="mg-data-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ background: '#f8fafc' }}>Status</th>
                                            <th style={{ background: '#f8fafc', textAlign: 'right' }}>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                        ...
                                                        <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                                                            <button 
                                                                ...
                                                                style={{ 
                                                                    ...
                                                                    padding: '6px 12px', borderRadius: '6px', fontSize: '12px', cursor: 'pointer', fontWeight: '700'
                                                                }}
                                                            >
                                                                Approve
                                                            </button>
            ...
            <div className="premium-bottom-nav mobile-only">
                ...
                <div className={`bottom-nav-item ${activeTab === 'requests' ? 'active' : ''}`} onClick={() => setActiveTab('requests')}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
                    <span>Approvals</span>
                </div>
